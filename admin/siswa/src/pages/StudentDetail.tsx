          ...
          <div style={{ marginTop: 16, background: '#fff', borderRadius: 10, padding: 16, boxShadow: '0 1px 4px rgba(0,0,0,0.06)', display: 'flex', gap: 24, flexWrap: 'wrap' }}>
            ...
            {student.whatsapp && (
              <a
                ...
                style={{ display: 'flex', alignItems: 'center', gap: 8, color: '#25D366', fontWeight: 600, fontSize: 14, textDecoration: 'none' }}
              >
            ...
            {student.tiktokAccount && (
              ...
              >
                <svg viewBox="0 0 24 24" width="20" height="20">
                  <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.06-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.28-2.26.54-4.5 2.14-6.11 1.46-1.49 3.52-2.33 5.59-2.33.15 0 .3.01.45.02.01 1.43.01 2.86.01 4.3-.87-.21-1.84-.1-2.6.43-.88.59-1.29 1.69-1.14 2.73.1 1.09.84 2.1 1.9 2.45.89.31 1.9.15 2.64-.47.69-.58 1.05-1.51 1.01-2.41-.04-5.32-.01-10.64-.02-15.97z" fill="currentColor" />
                </svg>
                @{student.tiktokAccount.replace(/^@/, '')}
              </a>
            )}
          </div>
